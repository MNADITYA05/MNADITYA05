...
My interests span across various domains such as Biomedical Image Processing, Machine Learning,Generative AI (Gen AI), Deep Learning, Natural Language Processing (NLP), and Computer Vision (CV). 
